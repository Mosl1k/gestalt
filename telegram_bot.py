...
async def suggest_dishes(update: Update, context):
    ...
    try:
        ...
        prompt = f"Что можно приготовить из таких продуктов: {', '.join(items_in_fridge)}? Назови только 7 названий блюд. Желательно из русской, татарской, грузинской, итальянской, вьетнамской, узбекской, японской кухонь. Пример: лагман, манты, хинкали, мясо по-французски, очпочмак, шаурма, бургер, пицца, борщ, солянка, курица во фритюре, на мангале, на пару."
        try:
